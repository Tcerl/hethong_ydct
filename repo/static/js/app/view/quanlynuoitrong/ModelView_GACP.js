define(function (require) {
	...
	var template 				= require('text!app/view/quanlynuoitrong/tpl/newmodel.html'),
    	...
    	tools : [
			{
				...
				label: "Quản lý quy trình nuôi trồng",
				command: function(){
					var self = this;
					...
					if (!nuoitrong_khaithac_id){
						...
						if (!!nuoitrong_khaithac_id){
							let path = "duoclieu_nuoitrong/model?id=" + nuoitrong_khaithac_id;
