define(function (require) {
    ...
    var template 				= require('text!app/view/diadiemnuoitrong/tpl/model.html'),
    ...
    return Gonrin.ModelView.extend({
				...
				command: function(){
					...
					self.model.save(null,{
						success: function (model, respose, options) {
                            ...
                            let path = 'diadiem_nuoitrong/collection'
    	...
    	render:function(){
    		...
    		if(id){
        		...
        		this.model.fetch({
                    ...
                    complete : function(){
                        var fileView1 = new ManageFileVIew({ viewData: { "listFile": self.model.get('dinhkem_chungnhan_kiemnghiem'), "$el_btn_upload": self.$el.find(".btn-add-file") }, el: self.$el.find(".list-attachment") });
                        fileView1.render();
		...
		validateData: function(){
            ...
            if (dientich === undefined || dientich === null || dientich === ""){
                self.getApp().notify({message : "Vui lòng nhập diện tích địa điểm nuôi trồng"}, {type : 'danger', delay : 1000});
                return false
            }
            ...
            if (donvitinh_dientich === undefined || donvitinh_dientich === null || donvitinh_dientich === ""){
                self.getApp().notify({message : "Vui lòng nhập đơn vị diện tích địa điểm nuôi trồng"}, {type : 'danger', delay : 1000});
                return false
            }
