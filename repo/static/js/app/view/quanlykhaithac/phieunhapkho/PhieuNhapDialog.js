define(function (require) {
	...
	var template 			= require('text!app/view/quanlykhaithac/phieunhapkho/tpl/phieunhap_dialog.html');  
    var schema = require('json!app/view/quanlykhaithac/phieunhapkho/PhieuNhapSchema.json');
        ...
        tools: [
			{
				...
				buttons: [
					...
					},
					{
						name: "save",
						type: "button",
						buttonClass: "btn-success btn ml-2 width-sm",
						...
						command: function () {
                            ...
                            $.ajax({
                                url: (self.getApp().serviceURL || "") + `/api/v1/phieunhapkho/create_khaithac`,
                                dataType: "json",
        ...
        render: function() {
			...
			if (viewData !== undefined && viewData !== null){
                ...
                if (id_sanpham === undefined || id_sanpham === null || id_sanpham===""){
                    ...
                    let thuhoach_khaithac_id = viewData.thuhoach_khaithac_id;
                    if (!!thuhoach_khaithac_id){
                        self.model.set("thuhoach_khaithac_id", thuhoach_khaithac_id);
                    }
                        ...
                        if (!id || self.isViewCq === true){
                            ...
                            if (so_lo === undefined || so_lo === null || so_lo===""){
                                if (!!obj.so_lo){
                                    ...
                                    console.log(self.model.get("so_lo"));
                                }
                            }
                        }
                        else{
