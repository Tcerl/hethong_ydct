define(function(require) {
    ...
    var ModelDialogView = require("app/quanly_thuongmai_dientu/SanPhamNhapKhau/ModelView");
    return Gonrin.CollectionView.extend({
        ...
        uiControl: {
            fields: [
				...
				{ field: "ten_thuong_mai", label: "Tên thương mại", width: 300 },
				{ field: "quocgia", label: "Nơi cung cấp", template: function(rowData) {
                    if (!!rowData.quocgia) {
                        return `${rowData.quocgia.ten}`;
                    } 
                    else {
                        return '';
                    }
        ...
        render: function() {
            var self = this;
            self.$el.find('.page-title').text('Danh sách sản phẩm nhập khẩu');
