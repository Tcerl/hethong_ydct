define(function(require) {
    ...
    var ModelDialogView = require("app/quanly_thuongmai_dientu/NhaSanXuatDonVi/ModelView");
    return Gonrin.CollectionView.extend({
        ...
        uiControl: {
            fields: [
                ...
                { field: "ma", label: "Mã đơn vị",width:100},
                { field: "ten", label: "Tên đơn vị", width: 350 },
        ...
        text_filter: null,
        render: function() {
            this.$el.find('.page-title').text('Danh sách nhà sản xuất');
            var self = this;
