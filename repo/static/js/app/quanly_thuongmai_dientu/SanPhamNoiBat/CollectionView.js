define(function(require) {
    ...
    var ModelDialogView = require("app/quanly_thuongmai_dientu/SanPhamNoiBat/ModelView");
    return Gonrin.CollectionView.extend({
        template: template,
        modelSchema: {},
        urlPrefix: "/api/v1/",
        collectionName: "sanpham_noibat_donvi",
        uiControl: {
            fields: [
        ...
        render: function() {
            var self = this;
            self.$el.find('.page-title').text('Danh sách sản phẩm nổi bật');
