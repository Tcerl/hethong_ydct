    ...
    return Gonrin.ModelView.extend({
        ...
        render:function(){
            ...
            if(check_ton === true){
                ...
                var url = (self.getApp().serviceURL || "") + '/api/v1/check_tonkho_dutru';
                $.ajax({
                    url: url,
                    type: 'POST',
                    dataType:"json",
            ...
            if (!!viewData_data && viewData_data !== undefined && viewData_data !== null && viewData_data.id !== null && viewData_data.id !== undefined) {
                ...
                this.model.fetch({
        			success: function(data){
                        self.applyBindings();
                        self.model.on("change:so_luong_du_tru change:ghichu change:dongia change:so_luong_du_tru change:so_luong_duyet_du_tru change:so_luong_ke_hoach", function(){
                            self.save_model();
                        });
                    },
                    error: function () {
            ...
            self.$el.find(".demo-delete-row").unbind("click").bind("click",function(){
                ...
                if(!!id_row){
                    ...
                    var url = (self.getApp().serviceURL || "") + '/api/v1/phieudutru_chitiet/' + id_row;
                    $.ajax({
                        url: url,
                        type: 'DELETE',
                        headers: {
