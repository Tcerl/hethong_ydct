define(function (require) {
    ...
    var template 				= require('text!app/danhmuc/danhmuc_donvi/DonViCungUng/tpl/model.html'),
		schema 				= require('json!schema/DonViCungUngSchema.json');
    	...
    	tools : [
			...
			},
			{
				...
				command: function(){
					...
					if (!ten || ten == undefined || ten == null) {
						self.getApp().notify({ message: "Vui lòng nhập tên đơn vị cung ứng"}, { type: "danger", delay: 1000 });
						return;
					}
