define(function (require) {
    ...
    var ModelDialogView = require("app/danhmuc/danhmuc_sanpham/DonViSanXuatNhapKhau/ModelView");
    return Gonrin.CollectionView.extend({
        ...
        tools: [
            {
                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        command: function () {
                            gonrinApp().exportExcelCategory(this, "danhmuc_donvisanxuat_nhapkhau");
                        }
                    },
                ],
            }],
        uiControl: {
            ...
            {
                field: "loai_donvi", label: "Loại Doanh Nghiệp", width: 250, template: function (rowData) {
                    if (!!rowData) {
                        if (rowData.loai_donvi == 1) {
                            return '<div>Ngoài nước</div>';
                        }
                        else if (rowData.loai_donvi == 2) {
        ...
        render: function () {
            ...
            this.$el.find('.page-title').text('Danh sách DN Sản Xuất');
