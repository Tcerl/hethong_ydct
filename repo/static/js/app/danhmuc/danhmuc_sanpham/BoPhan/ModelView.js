define(function (require) {
    ...
    var template 				= require('text!app/danhmuc/danhmuc_sanpham/BoPhan/tpl/model.html'),
    ...
    return Gonrin.ModelDialogView.extend({
		...
		validateData: function(){
			var self = this;
			if(!self.model.get('ma_bophan')){
				self.getApp().notify({ message: "Chưa nhập mã bộ phận"}, { type: "danger", delay: 1000 });
				return false;
			}
			if(!self.model.get('ten_bophan')){
				self.getApp().notify({ message: "Chưa nhập tên bộ phận"}, { type: "danger", delay: 1000 });
				return false;
			}
			return true;
		},
