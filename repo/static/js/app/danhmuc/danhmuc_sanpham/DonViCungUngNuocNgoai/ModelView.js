define(function (require) {
    ...
    var template = require('text!app/danhmuc/danhmuc_sanpham/DonViCungUngNuocNgoai/tpl/model.html'),
    ...
    return Gonrin.ModelDialogView.extend({
        ...
        validateData: function () {
            ...
            if (!self.model.get('ten_donvi')) {
                self.getApp().notify({ message: "Chưa nhập tên đơn vị" }, { type: "danger", delay: 1000 });
                return false;
            }
