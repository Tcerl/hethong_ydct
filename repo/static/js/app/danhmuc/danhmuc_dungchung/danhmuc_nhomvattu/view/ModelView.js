define(function (require) {
    ...
    var template 				= require('text!app/danhmuc/danhmuc_dungchung/danhmuc_nhomvattu/tpl/model.html'),
				...
				command: function(){
					...
					self.model.save(null,{
						success: function (model, respose, options) {
							...
							var path = "danhmuc_nhom_vattu/collection"
    	...
    	render:function() {
    		...
    		if(id){
        		...
        		this.model.fetch({
        			...
        			error:function() {
    					self.getApp().notify("Lấy dũ liệu không thành công.");
    				},
        		});
    		}else{
    			self.applyBindings();
