define(function(require) {
    ...
    var ModelDialogView = require("app/danhmuc/danhmuc_dungchung/danhmuc_nhacungcap/ModelView");
    ...
    return Gonrin.CollectionView.extend({
        ...
        uiControl: {
            fields: [
                ...
                { field: "ma_donvi", label: "Ma don vi", width: 150 },
                { field: "ten_donvi", label: "Tên đơn vị", width: 350 },
        ...
        text_filter: null,
        render: function() {
            this.$el.find('.page-title').text('Danh sách nhà cung cấp');
            var self = this;
            ...
            filter.render();
            self.uiControl.orderBy = [{ "field": "ma_donvi", "direction": "asc" }];
            self.applyBindings();
