define(function(require) {
    ...
    var template = require('text!app/giaychungnhanco/tpl/model.html'),
            ...
            buttons: [
                {
                    ...
                    command: function() {
                        ...
                        if (self.changeChiTiet || self.addNew){
                            var backContine = null;
                            self.$el.find("#exampleModalCenter3").modal("show");
                            self.$el.find(".btn-item-back-continue").unbind("click").bind("click", function () {
                                backContine = true;
                            });

                            self.$el.find("#exampleModalCenter3").on("hidden.bs.modal", function (e) {
                                if (backContine == true) {
            ...
            if (id) {
                ...
                this.model.fetch({
                    success: function(data) {
                        ...
                        if (self.model.get("tao_phieu_nhap") === true){
