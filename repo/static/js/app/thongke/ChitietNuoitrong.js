define(function (require) {
    ...
    var template 				= require('text!app/thongke/tpl/chitiet_nuoitrong.html');
    ...
    return Gonrin.ModelDialogView.extend({
                ...
                for (var i =0; i<length; i++){
                    ...
                    if (list_sanpham.length>0){
                        for (var j=0; j<list_sanpham.length; j++){
                            ...
                            var so_luong_nuoitrong = sanpham.so_luong_nuoitrong;
                            ...
                            if (j==0){
                                ...
                                var td_so_luong_nuoitrong = `<td class ="text-right">` + (so_luong_nuoitrong? Number(so_luong_nuoitrong).toLocaleString("de-DE") : 0) + `</td>`;
                                var td_so_co = "";
                                ...
                                tr_first += td_so_luong_nuoitrong;	
                                ...
                                tr_second += td_so_luong_nuoitrong;	
        ...
        xuatExcel: function(tungay, denngay, donvi_id, id_sanpham){
            var self = this;
			let url = (self.getApp().serviceURL || "") + '/api/v1/excel/thongke_nuoitrong';
			let params = {
				ngay_bat_dau: tungay,
