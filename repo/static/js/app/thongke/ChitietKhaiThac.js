define(function (require) {
    ...
    var template 				= require('text!app/thongke/tpl/chitiet_khaithac.html');
    ...
    return Gonrin.ModelDialogView.extend({
                ...
                for (var i =0; i<length; i++){
                    ...
                    if (list_sanpham.length>0){
                        for (var j=0; j<list_sanpham.length; j++){
                            ...
                            var soluong_khaithac = sanpham.so_luong_khaithac;
                            ...
                            if (j==0){
                                ...
                                var td_soluong_khaithac = `<td class ="text-right">` + (soluong_khaithac? Number(soluong_khaithac).toLocaleString("de-DE") : 0) + `</td>`;
                                var td_so_co = "";
        ...
        xuatExcel: function(tungay, denngay, donvi_id, id_sanpham){
            var self = this;
			let url = (self.getApp().serviceURL || "") + '/api/v1/excel/thongke_khaithac';
			let params = {
				ngay_bat_dau: tungay,
				ngay_ket_thuc: denngay,
				id_sanpham,
