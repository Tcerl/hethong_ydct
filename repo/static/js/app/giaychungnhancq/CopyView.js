define(function (require) {
    ...
    var template = require('text!app/giaychungnhancq/tpl/copy.html'),
    ...
    return Gonrin.ModelDialogView.extend({
                        ...
                        command: function () {
                            ...
                            self.model.save(null, {
                                success: function (model, respose, options) {
                                    ...
                                    self.close();
                                    self.trigger('saveData', {data: self.model.get("id")});
                                },
        ...
        render: function () {
            ...
            if (viewData){
                delete viewData.id;
                delete viewData.id_sanpham;
                delete viewData.ma_sanpham;
                delete viewData.loai_sanpham;
                delete viewData.ten_sanpham;
                delete viewData.sanpham;
                delete viewData.ketqua;
                delete viewData.chungtu_dinhkem;
