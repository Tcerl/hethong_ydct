        ...
        uiControl: {
                            ...
                            <div class="card">
                                <div class="card-body row">
                                        ...
                                        <div class="col-12 col-md-4 text-center">
                                            ...
                                            <a download="QRCode.png" class="col-sm-8">
                                                <button class="btn btn-primary btn-sm" id="qr_${rowData.id}"><i class="fas fa-download"></i> Tải mã QR</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
            ...
            onRendered: function(e) {
                ...
                for (let i=0; i<length;i++){
                    ...
                    self.$el.find(`#${id}`).unbind('click').bind('click', function(e) {
                        e.stopPropagation();
                        var image_src = self.$el.find(`#${id} img`).attr("src");
                    ...
                    self.$el.find(`#qr_${id}`).unbind("click").bind('click', function(){
                        var image_src = self.$el.find(`#${id} img`).attr("src");
                        self.$el.find(`#qr_${id}`).parent().attr("download","QRCode.png");
                        self.$el.find(`#qr_${id}`).parent().attr("href", image_src);
                    });
                }
