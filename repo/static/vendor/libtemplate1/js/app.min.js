...
!function ($) {
    ...
    Components.prototype.initMultiDropdown = function () {
        $('.dropdown-menu a.dropdown-toggle').on('click', function(e) {
            console.log("Components.dropdown-menu click namdv========");
    ...
    */
    ...
    Portlet.prototype.init = function() {
        ...
        $(document).on("click",this.$portletCloser, function (ev) {
            console.log("ortlet.prototype.init click namdv====1====",this.$portletCloser);
            ev.preventDefault();
        ...
        $(document).on("click",this.$portletRefresher, function (ev) {
            console.log("ortlet.prototype.init click namdv====2====",this.$portletRefresher);
            ev.preventDefault();
            var $portlet = $(this).closest($this.$portletIdentifier);
    ...
    */
    ...
    App.prototype.init = function () {
        ...
        if (window.sessionStorage && bodyConfig && bodyConfig.hasOwnProperty('showRightSidebarOnPageLoad') && bodyConfig['showRightSidebarOnPageLoad']) {
            var alreadyVisited = sessionStorage.getItem("_COCQ_VISITED_");
            if (!alreadyVisited) {
                $.RightBar.toggleRightSideBar();
                sessionStorage.setItem("_COCQ_VISITED_", true);
            }
        }
    },
